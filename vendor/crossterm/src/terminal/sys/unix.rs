...
pub(crate) fn size() -> io::Result<(u16, u16)> {
    ...
    // LOCAL PATCH — see vendor/crossterm/LOCAL_PATCH.md. Upstream falls back to spawning `tput`
    // here; we drop it (ioctl-only) to shed the Command/env-map/Debug subtree that pulls in.
